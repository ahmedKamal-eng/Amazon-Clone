...
class _UploadItemsScreenState extends State<UploadItemsScreen> {
  ...
  saveBrandInfo(){
    FirebaseFirestore.instance
      ...
      'itemInfo':itemController.text.trim(),
  ...
  validateUploadForm() async{
    ...
    if(imageXFile != null)
    {
      if(itemController.text.isNotEmpty && titleController.text.isNotEmpty
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            leading:const Icon(Icons.price_change,color: Colors.deepPurple,),
            title: SizedBox(
              width: 250,
              child:  TextField(
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Icon(Icons.add_photo_alternate,color: Colors.white,size: 200,),
