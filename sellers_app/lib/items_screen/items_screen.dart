...
import 'package:sellers_app/items_screen/items_ui_design_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>UploadItemsScreen(model: widget.model,)));
              },
              icon: Icon(
                ...
                if(dataSnapshot.hasData)
                {
                  return SliverStaggeredGrid.countBuilder(
                    ...
                    itemBuilder: (context,index){
                      ...
                      return ItemsUiDesignWidget(model: itemModel,context: context,);
                    },
